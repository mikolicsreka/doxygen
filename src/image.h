...
using Width = NamedType<uint, struct WidthTag>;
using Height = NamedType<uint, struct HeightTag>;

/*(Width width, Height height); will be in constructors ...
...
class Image
{
  public:
   ...
   ~Image();
    ...
    uint width() const { return imageData.m_width; }
    uint height() const { return imageData.m_height; }
    uchar *data() const { return imageData.m_data; }
